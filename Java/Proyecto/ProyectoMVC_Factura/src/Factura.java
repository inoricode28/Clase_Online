...
public class Factura extends JFrame {
 ...
 private void multiplicarNumero() { 
    try {
        ...
        double IGVSOLES = (PBasicoDolar*Dolar) *0.18;
        ...
        // //Salidas
        txtPbasico.setText(String.format("%.2f", PBasicoDolar));
        txtPbasicosoles.setText(String.format("%.2f", PBasicoSoles));
        txtigv.setText(String.format("%.2f", IGVDOLAR));
        txtigvsoles.setText(String.format("%.2f", IGVSOLES));
        txttotal.setText(String.format("%.2f", ResultDolar));
        txttotalsoles.setText(String.format("%.2f", ResultSoles));
